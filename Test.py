...
if __name__ == "__main__":
    ...
    team1.add("El Matador",Testcoeq()) #Strategie Fonceur
    #team2.add("Omonstro",Testcoeq()) #Strategie Attaquant
    team1.add("messi",MesStrategies.Defenceur()) #Strategie Defenseu
    #team2.add("ujfgj",MesStrategies.Fonceur())
    #team1.add("ujfgj",MesStrategies.Solo()) #Strategie Attaquant
    #team2.add("messi",MesStrategies.Defenceur())
